...
lifetable_simulated_5state=simulate_life_table(model_type, param_file, female,year = 2012,wave_index = 8,latent = 0,init_age,init_state = 0,n_sim = 100,cohort = 1,mean = FALSE)
mean_lifetable_simulated_5state=simulate_life_table(model_type, param_file, female,year = 2012,wave_index = 8,latent = 0,init_age,init_state = 0,n_sim = 100,cohort = 1,mean = TRUE)
