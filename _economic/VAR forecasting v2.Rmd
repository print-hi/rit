...
zcp3m = ts(zcp$x1_qtrs / 100)
zcp10y_spread = ts((zcp$x40_qtrs - zcp$x1_qtrs)/100)

all_data_original$zcp3m = zcp$x1_qtrs / 100 
all_data_original$zcp10y = zcp$x40_qtrs / 100 
all_data_original$Date = zcp$Qtr
...
# import 
asx200 = read.csv("asx200_price.csv")
...
# plot(all_data_original$Date, all_data_original$zcp3m * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("r^{(1)}"))
# # 10-year zero-coupon yield
# plot(all_data_original$Date, all_data_original$zcp10y * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("r^{(40)}"))
# # 10-year zero-coupon spread 
# plot(all_data_original$Date, zcp10y_spread * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("r^{(40)} - r^{(1)}"))
# abline(h = 0, lty = 2)
...
# plot(all_data_original$Date, all_data_original$rental_yield * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("y_t"))
# abline(h = 0, lty = 2)
# # GDP
# plot(all_data_original$Date, all_data_original$GDP, "l", ylab = "", xlab = "Year", main = TeX("GDP "))
# # CPI
# plot(all_data_original$Date, all_data_original$CPI, "l", ylab = "Index Value", xlab = "Year", main = TeX("CPI "))
...
# plot(zcp10y$Qtr, home_value_houses_nsw * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("h_t"))
# abline(h = 0, lty = 2)
# # plot(zcp10y$Qtr, rental_houses_nsw, "l", ylab = "yield", xlab = "", main = "Hedonic rental yields \n Sydney houses")
# plot(zcp10y$Qtr, gdp * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("g_t "))
# abline(h = 0, lty = 2)
# # plot(zcp10y$Qtr, corpBBB_10y_spread, "l")
# plot(zcp10y$Qtr, asx200 * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("a_t"))
# abline(h = 0, lty = 2)
# # plot(zcp10y$Qtr, unemploy_nsw, "l", ylab = "rate", xlab = "", main = "NSW unemployment rates")
# plot(zcp10y$Qtr, forex * 100, "l", ylab = "(%)", xlab = "Year", main = TeX("d_t"))
# abline(h = 0, lty = 2)
# 
# ##########
# # combined
# par(mfrow = c(1,2))
# # zcp3m vs mortgage
# plot(all_data_original$Date, all_data_original$zcp3m*100, "l", ylab = "(%)", ylim = c(-1,11), xlab = "Year", main = "Correlation of 3-month zero-coupon yield \n and mortgage rate")
...
# plot(all_data_original$Date, zcp10y_spread*100, "l", ylab = "(%)", ylim = c(-1.5,11), xlab = "Year", main = "Correlation of 10-year zero-coupon spread \n and NSW unemployment rate")
...
plot_data_forecast = c(all_data_original$zcp3m[1+train_index]*100, zcp3m_forecast*100)
zcp3m_upper = zcp3m_inv(test_forecast$fcst$zcp3m_stationary[,3], all_data_original$zcp3m[max(train_index)])
plot_data_upper = c(all_data_original$zcp3m[1+train_index]*100, zcp3m_upper*100)
zcp3m_lower = zcp3m_inv(test_forecast$fcst$zcp3m_stationary[,2], all_data_original$zcp3m[max(train_index)])
plot_data_lower = c(all_data_original$zcp3m[1+train_index]*100, zcp3m_lower*100)

plot(all_data_original$Date[-1], plot_data_forecast, "l", ylim = c(-0.05, 8), main = TeX("r^{(1)}"), ylab = "", xlab = "")
lines(all_data_original$Date[-1], all_data_original$zcp3m[-1]*100, col = "blue")
...
plot_data_forecast = c(all_data_original$zcp10y[1+train_index]*100, zcp10y_forecast*100)
plot_data_upper = zcp10y_inv(test_forecast$fcst$zcp10y_spread[,3], zcp3m_upper)
plot_data_upper = c(all_data_original$zcp10y[1+train_index]*100, plot_data_upper*100)
plot_data_lower = zcp10y_inv(test_forecast$fcst$zcp10y_spread[,2], zcp3m_lower)
plot_data_lower = c(all_data_original$zcp10y[1+train_index]*100, plot_data_lower*100)

plot(all_data_original$Date[-1], plot_data_forecast, "l", ylim = c(0, 10.5), main = TeX("r^{(40)}"), ylab = "", xlab = "")
lines(all_data_original$Date[-1], all_data_original$zcp10y[-1]*100, col = "blue")
lines(all_data_original$Date[-1], plot_data_upper, lty = 2)
lines(all_data_original$Date[-1], plot_data_lower, lty = 2)
...
###################
# zcp10 year spread
plot_data_forecast = c(all_data[1+train_index,2]*100, test_forecast$fcst$zcp10y_spread[,1]*100)
plot_data_upper = c(all_data[1+train_index,2]*100, test_forecast$fcst$zcp10y_spread[,3]*100)
plot_data_lower = c(all_data[1+train_index,2]*100, test_forecast$fcst$zcp10y_spread[,2]*100)

plot(all_data_original$Date[-1], plot_data_forecast, "l", ylim = c(-1.5, 4.5), main = TeX("r^{(40)} - r^{(1)}"), ylab = "", xlab = "")
lines(all_data_original$Date[-1], all_data[-1,2]*100, col = "blue")
lines(all_data_original$Date[-1], plot_data_upper, lty = 2)
lines(all_data_original$Date[-1], plot_data_lower, lty = 2)
...
par(mfrow = c(3,3))
# zcp3m
plot(all_data_original$Date[-c(1:2)], full_res[,1], "l", main = TeX("\tilde{r}^{(1)}  residuals"), xlab = "", ylab = "")
abline(h = 0, lty = 2)
# zcp10y 
...
abline(h = 0, lty = 2)
# TeX("\tilde{y}_t")
plot(all_data_original$Date[-c(1:2)], full_res[,4], "l", main = TeX("\tilde{y}_t  residuals"), xlab = "", ylab = "")
abline(h = 0, lty = 2)
# TeX("g_t")
...
##########
# forecast 
full_forecast = predict(full_var, n.ahead = 40, interval = "prediction", ci = 0.9)
forecast_date = c(all_data_original$Date[-1], as.yearqtr(seq(as.Date("2021-04-01"), by="quarter", length.out = 40)))

source("VAR_simulation.R")

num_paths = 10
sim_paths = get_var_simulations(num_years = 10, num_paths = 10)
```
...
# zcp3 month
# simulations 
plot_data_forecast = c(all_data_original$zcp3m[-1]*100, sim_paths$zcp3m[,1]*100)
plot(forecast_date, plot_data_forecast, "l", ylim = c(-5, 10), main = TeX("r^{(1)}"), ylab = "(%)", xlab = "", col = "grey")
for (i in 2:(num_paths - 1)) {
    plot_data_forecast = c(all_data_original$zcp3m[-1]*100, sim_paths$zcp3m[,i]*100)
...
plot_data_forecast = c(all_data_original$zcp3m[-1]*100, zcp3m_forecast*100)
...
plot_data_upper = c(all_data_original$zcp3m[-1]*100, zcp3m_upper*100)
...
plot_data_lower = c(all_data_original$zcp3m[-1]*100, zcp3m_lower*100)
...
plot(forecast_date, plot_data_forecast, "l", ylim = c(25, 275), main = TeX("HVI"), ylab = "Index Value", xlab = "", col = "grey")
for (i in 2:(num_paths - 1)) {
...
# rental yield 
# simulations 
plot_data_forecast = c(all_data_original$rental_yield[-1], sim_paths$rental_yield[,1]*100)
plot(forecast_date, plot_data_forecast, "l", ylim = c(-2.5, 15), main = TeX("y_t"), ylab = "(%)", xlab = "", col = "grey")
for (i in 2:(num_paths - 1)) {
    plot_data_forecast = c(all_data_original$rental_yield[-1], sim_paths$rental_yield[,i]*100)
    lines(forecast_date, plot_data_forecast, col = "grey")
}
# central 
...
plot_data_forecast = c(all_data_original$rental_yield[-1], plot_data_forecast*100)
lines(forecast_date, plot_data_forecast)
# upper 
...
plot_data_upper = c(all_data_original$rental_yield[-1], plot_data_upper*100)
lines(forecast_date, plot_data_upper, lty = 2)
# lower 
...
plot_data_lower = c(all_data_original$rental_yield[-1], plot_data_lower*100)
lines(forecast_date, plot_data_lower, lty = 2)
...
plot(forecast_date, plot_data_forecast, "l", ylim = c(60, 150), main = TeX("CPI"), ylab = "Index Value", xlab = "", col = "grey")
for (i in 2:(num_paths - 1)) {
...
plot(forecast_date, plot_data_forecast, "l", ylim = c(2000, 10000), main = TeX("ASX"), ylab = "Price", xlab = "", col = "grey")
for (i in 2:(num_paths - 1)) {
...
plot(forecast_date, plot_data_forecast, "l", ylim = c(48, 100), main = TeX("AUD"), ylab = "Index Value", xlab = "", col = "grey")
for (i in 2:(num_paths - 1)) {
...
```{r}
##########################
# plots on stationary scales 
par(mfrow = c(3,3))

sim_paths_stationary = sim_paths
sim_paths_stationary$zcp3m_yield = sim_paths$zcp3m_yield - dplyr::lag(sim_paths$zcp3m_yield, n = 1)
sim_paths_stationary$home_index = log(sim_paths$home_index) - log(dplyr::lag(sim_paths$home_index, n = 1))
sim_paths_stationary$rental_yield = sim_paths$rental_yield - dplyr::lag(sim_paths$rental_yield, n = 1)
sim_paths_stationary$GDP = log(sim_paths$GDP) - log(dplyr::lag(sim_paths$GDP, n = 1))
sim_paths_stationary$CPI = log(sim_paths$CPI) - log(dplyr::lag(sim_paths$CPI, n = 1))
sim_paths_stationary$ASX200 = log(sim_paths$ASX200) - log(dplyr::lag(sim_paths$ASX200, n = 1))

############
# zcp3 month
# central 
plot_data_forecast = c(all_data_stationary[,1], full_forecast$fcst$zcp3m_stationary[,1])
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("\tilde{r}^{(1)}"), ylab = "(%)", xlab = "")
# upper 
plot_data_upper = c(all_data_stationary[,1], full_forecast$fcst$zcp3m_stationary[,3]*100)
lines(forecast_date, plot_data_upper, lty = 2)
# lower 
plot_data_lower = c(all_data_stationary[,1], full_forecast$fcst$zcp3m_stationary[,2]*100)
lines(forecast_date, plot_data_lower, lty = 2)
...
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("h_t"), ylab = "(%)", xlab = "")
# upper 
...
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("\tilde{y}_t"), ylab = "(%)", xlab = "")
# upper 
...
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("g_t"), ylab = "(%)", xlab = "")
# upper 
...
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("c_t"), ylab = "(%)", xlab = "")
# upper 
...
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("a_t"), ylab = "(%)", xlab = "")
# upper 
...
plot(forecast_date, plot_data_forecast*100, "l", main = TeX("d_t"), ylab = "(%)", xlab = "")
# upper 
...
# 
# plot(ecdf(all_data_stationary[,1]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of \tilde{r}^{(1)}"), xlab = "(%)", ylab = "", xlim = c(-2, 2))
# plot(ecdf(melt(sim_paths_stationary$zcp3m)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T,  col = "blue")
# legend("topleft", legend = c("Historic", "Simulated"), col = c("black", "blue"), lty = 1)
# 
# plot(ecdf(all_data_stationary[,2]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of r^{(40)} - r^{(1)}"), xlab = "(%)", ylab = "", xlim = c(-2,3.5))
# plot(ecdf(melt(sim_paths_stationary$zcp10y)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T, col = "blue")
# 
# plot(ecdf(all_data_stationary[,3]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of h_t"), xlab = "(%)", ylab = "", xlim = c(-0.05, 0.1))
# plot(ecdf(melt(sim_paths_stationary$home_index)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T, col = "blue")
# 
# plot(ecdf(all_data_stationary[,4]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of \tilde{y}_t"), xlab = "(%)", ylab = "", xlim = c(-0.05, 0.05))
# plot(ecdf(melt(sim_paths_stationary$rental_yield)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T, col = "blue")
# 
# plot(ecdf(all_data_stationary[,5]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of g_t"), xlab = "(%)", ylab = "", xlim = c(-0.05, 0.05))
# plot(ecdf(melt(sim_paths_stationary$GDP)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T, col = "blue")
# 
# plot(ecdf(all_data_stationary[,6]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of c_t"), xlab = "(%)", ylab = "", xlim = c(-0.02, 0.03))
# plot(ecdf(melt(sim_paths_stationary$CPI)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T, col = "blue")
# 
# plot(ecdf(all_data_stationary[,7]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of a_t"), xlab = "(%)", ylab = "", xlim = c(-0.25, 0.25))
# plot(ecdf(melt(sim_paths_stationary$ASX200)$value*100),verticals=T, do.points=F,col.01line = NULL, add = T, col = "blue")
# 
# plot(ecdf(all_data_stationary[,8]*100), verticals=T, do.points=F,col.01line = NULL, main = TeX("CDF of d_t"), xlab = "(%)", ylab = "", xlim = c(-0.1, 0.1))
# plot(ecdf(melt(sim_paths_stationary$forex)$value*100), verticals = T, do.points=F,col.01line = NULL, add = T, col = "blue")
```
