...
# save(param_indep, file = "param_indep2.RData")
# save(Xt_indep_fitted, file = "Xt_indep_fitted2.RData")
# # 
...
par(mfrow = c(3,2))
>>>>>>> 443914675d4875a6c76b765626aa93ca8e484b80
...
load("Xt_corr_fitted.RData")
load("param_corr.RData")
# init_para_un = c(-0.0476178177,  0.1883954039,  0.0541799806,  0.2064502345 , 0.2015218743, 0.0146430812,  0.1045131689,  0.0775538368,  0.0614675899, -0.0230449955,-0.0083917935,  0.0058363718, -0.0051956064,  0.0833732357,  0.0578036401,  0.0582078076,  0.0007094596, -0.1004346733, -0.2186760439,  0.0080832384, 0.0090482006,  0.0090737995,  0.0069131880,  0.0054576034,  0.0051214121,  0.0050331757,  0.0031130047,  0.0031930137,  0.0026735465,  0.0022726559,  0.0019033178,  0.0016513816,  0.0013720447,  0.0009117307,  0.0008735190,  0.0007680491,  0.0005937637,  0.0004093408,  0.0002576219,  0.0001553900,  0.0001260321,  0.0001332250,  0.0001758465,  0.0002983394,  0.0003039219,  0.0003742852,  0.0003395232,  0.0002577990,  0.0002057602, -0.0001150165,  0.0000144974,  0.0001768591,  0.0003043769,  0.0004212505,  0.0006777493,  0.0009113994,  0.0010890702,  0.0021454108,  0.0018323320)
...
#           method = c("Nelder-Mead"), m.spot = m.spot)
# stopCluster(cl)
# save(param_corr, file = "param_corr.RData")
# save(Xt_corr_fitted, file = "Xt_corr_fitted.RData")
