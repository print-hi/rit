...
loglike = function(para_un, m.spot) {
    ...
    Q = integrate_matrix(from = 0, to = dt, num_step = 10)
    Q0 = integrate_matrix(from = 0, to = 2.5, num_step = 100)
    xt_term = integrate_matrix2(from = 0, to = dt, num_step = 10)
...
load("Xt_gcorr_fitted_shorter.RData")
load("param_gcorr_shorter.RData")
...
param_gcorr = optim(init_para_un, loglike,
          ...
          method = c("Nelder-Mead"), m.spot = m.spot)
stopCluster(cl)
save(param_gcorr, file = "param_gcorr_shorter.RData")
save(Xt_gcorr_fitted, file = "Xt_gcorr_fitted_shorter.RData")
