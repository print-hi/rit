...
loglike = function(para_un, m.spot) {
    ...
    Q = integrate_matrix(from = 0, to = dt, num_step = 120)
    # Q0 = integrate_matrix(from = 0, to = 20, num_step = 480)
    xt_term = integrate_matrix2(from = 0, to = dt, num_step = 120)
...
# house
# sim
# plot_data = c(m.spot[,41], log(Xt_gindep_sim[[1]][4,-1] / Xt_gindep_sim[[1]][4,1]) + m.spot[341,41])
# plot(plot_date, plot_data, "l", main = "Simulated house indexes", xlab = "", ylab = "", col = "grey")
# for (i in 2:num_paths) {
#   plot_data = c(m.spot[,41], log(Xt_gindep_sim[[i]][4,-1] / Xt_gindep_sim[[i]][4,1]) + m.spot[341,41])
#   lines(plot_date, plot_data, col = "grey")
# }
# # mean
# plot_data = c(m.spot[,41], log(Xt_gindep_mean[4,-1] / Xt_gindep_mean[4,1]) + m.spot[341,41])
# lines(plot_date, plot_data)
...
# stock
# sim
# plot_data = c(m.spot[,42], log(Xt_gindep_sim[[1]][5,-1] / Xt_gindep_sim[[1]][5,1]) + m.spot[341,42])
# plot(plot_date, plot_data, "l", main = "Simulated stock prices", xlab = "", ylab = "", col = "grey")
# for (i in 2:num_paths) {
#     plot_data = c(m.spot[,42], log(Xt_gindep_sim[[i]][5,-1] / Xt_gindep_sim[[i]][5,1]) + m.spot[341,42])
#     lines(plot_date, plot_data, col = "grey")
# }
# # mean
# plot_data = c(m.spot[,42], log(Xt_gindep_mean[5,-1] / Xt_gindep_mean[5,1]) + m.spot[341,42])
# lines(plot_date, plot_data)
...
load("param_gcorr.RData")
init_para_un = param_gcorr$par
init_para_un[1:15] = c(0.0475592317, 0.5748226990,  0.4097137770, -0.0840235925,  0.5399904687, -0.5759468991, -0.1441768904 , 0.2141827041,  0.8868924683, 0.1104182340,  0.0356603515, -0.2683629035,  0.0753902709 , 0.0655699795,-0.1195371885)
npara = length(init_para_un) # # of observations
